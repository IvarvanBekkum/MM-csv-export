...
class App:
	def __init__(self,parent):
		...
		self.frame.pack(padx=2,pady=2)
   		...
   		self.entry = Label(self.frame,width=110, text="This script will save the track points of the currently selected tracks as CSV file for the MilkMachine Plugin for QGIS-ddmmyy.")
